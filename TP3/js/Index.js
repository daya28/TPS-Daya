...
function selectNivel(){
	...
	var nivelSeleccionado = ($("#niveles option:selected").val()); //me trae el valor de la opcion seleccionada

	console.log('Selecciona un nivel');

	switch(nivelSeleccionado){

		case "1":
					turnos = 18;
					console.log('facil'); break;

		case "2":
					turnos = 12;
					console.log('intermedio'); break;

		case "3":
					turnos = 8;
					console.log('experto'); break;
...
$('#intentosP').text(/*'intentos disponibles: '*/ +turnos)
}
